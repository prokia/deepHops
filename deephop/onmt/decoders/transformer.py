...
class TransformerDecoder(nn.Module):
    ...
    def forward(self, tgt, memory_bank, state, memory_lengths=None,
                step=None, cache=None, condition=None):
        """
        ...
        if self.layer_norm.a_2.shape[0] > emb.shape[-1]:
            condition_of_every_atom = make_condtion(condition, emb.size(0), emb.device, emb.dtype)
