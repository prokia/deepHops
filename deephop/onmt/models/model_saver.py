...
class ModelSaverBase(object):
    ...
    def __init__(self, base_path, model, model_opt, fields, optim,
        ...
        self.begin_step = self.optim._step
        self.init_save_checkpoint_steps = save_checkpoint_steps
    ...
    def maybe_save(self, step):
        ...
        if (step - self.begin_step) % self.save_checkpoint_steps != 0:
            return

        if len(self.checkpoint_queue) > 30 and self.init_save_checkpoint_steps == self.save_checkpoint_steps:
            self.save_checkpoint_steps = self.save_checkpoint_steps*5
