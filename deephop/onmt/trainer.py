...
class Trainer(object):
    ...
    def train(self, train_iter_fct, valid_iter_fct, train_steps, valid_steps):
        ...
        begin_step = self.optim._step
        logger.info(f'the pretrained model step {begin_step} ...')
        true_batchs = []
        accum = 0
        normalization = 0
    ...
    def validate(self, valid_iter):
        ...
        for batch in valid_iter:
            ...
            outputs, attns, _ = self.model((src, batch.graph, batch.condition_target), tgt, src_lengths)
        ...
        for batch in true_batchs:
            ...
            for j in range(0, target_size-1, trunc_size):
                ...
                outputs, attns, dec_state = \
                    self.model((src, batch.graph, batch.condition_target), tgt, src_lengths, dec_state)
