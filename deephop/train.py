...
if __name__ == "__main__":
    ...
    group.add_argument('-use_graph_embedding', action='store_true', default=False,
                       help='using the embedding of protein as condition')
    group.add_argument('-condition_dim', type=int, default=0,
                       help='embedding size of protein')
    group.add_argument('-arch', type=str, default='before_linear', choices=['before_linear', 'after_encoding', 'after_decoding', 'no_cond',
                                                                            'transformer'],
